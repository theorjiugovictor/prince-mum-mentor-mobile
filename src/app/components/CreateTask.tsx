...
const CreateTaskForm: React.FC<{
    ...
    const mutation = useMutation({
        mutationFn: (newTask: any) => (initData ? updateTask(newTask) : createTask(newTask)),
        onSuccess: data => {
        ...
        onError: error => {
            ...
            showToast.error("Error",
                "Failed to " + (initData ? "update" : "create") + " task");
    ...
    return (
        ...
        >
            ...
            <View style={taskStyles.buttonRow}>
                <PrimaryButton
                    title={
                        mutation.isPending ? "Saving..." : initData ? "Update Task" : "Create Task"
                    }
                    onPress={initData ? handleUpdateTask : handleCreateTask}
                    style={taskStyles.createTaskButton}
                    disabled={!taskName.trim() || !dueDate || mutation.isPending}
                />
